#!/usr/bin/env python3
"""
Sweep through random_state values for efficient_tabular_mlp model.
...
OUTPUT_CSV = str(PROJECT_ROOT / 'random_state_sweep_results_efficient_tabular_mlp.csv')
MODEL_TYPE = 'efficient_tabular_mlp'
EXPERIMENT_NAME = 'random_state_sweep_efficient_tabular_mlp'
...
def main():
    parser = argparse.ArgumentParser(description='Sweep random_state values for efficient_tabular_mlp')
    ...
    while random_state <= args.max:
        ...
        temp_config = str(PROJECT_ROOT / f'temp_config_rs{random_state}_efficient_tabular_mlp.yaml')
