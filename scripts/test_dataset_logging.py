...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\nNext steps:")
        print("1. Run the processing pipeline: python run_pipeline.py --config configs/model_config.yaml process")
        print("2. Run training with dataset auto-discovery: python run_pipeline.py --config configs/model_config.yaml train --model-type random_forest")
        print("3. Or specify a specific run: python run_pipeline.py --config configs/model_config.yaml train --model-type random_forest --use-dataset-from-run <run_id>")
    else:
