...
OUTPUT_CSV = str(PROJECT_ROOT / 'random_state_sweep_results_gradient_boosting.csv')
...
def main():
    ...
    while random_state <= args.max:
        ...
        temp_config = str(PROJECT_ROOT / f'temp_config_rs{random_state}_gradient_boosting.yaml')
